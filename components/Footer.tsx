    ...
    <footer className="bg-black text-white pt-16 pb-8 border-t border-gray-900">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          {/* Brand Info */}
          <div>
            <div className="text-3xl font-black text-kia-red tracking-tighter mb-6">KIA LONG BIÊN</div>
            <p className="text-gray-400 mb-6 leading-relaxed">
              Đại lý ủy quyền chính hãng của KIA Việt Nam. Cam kết mang đến trải nghiệm mua xe đẳng cấp và dịch vụ hậu mãi tiêu chuẩn quốc tế.
            </p>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4 text-gray-400 font-opensans">
              ...
              <li className="flex items-center gap-3">
                ...
                <span>lienhe@kialongbien.vn</span>
              </li>
            </ul>
          </div>
        </div>
