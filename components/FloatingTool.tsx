      ...
      <div className="bg-white rounded-lg shadow-[0_20px_50px_rgba(0,0,0,0.15)] p-6 md:p-8 border border-gray-100">
        <div className="flex flex-col lg:flex-row items-end gap-4 lg:gap-6">
          ...
          <div className="w-full lg:w-auto min-w-[200px]">
            <button className="w-full h-full bg-gray-600 text-white font-montserrat font-bold py-4 px-8 rounded-lg hover:bg-black transition-colors flex items-center justify-center gap-2 uppercase text-sm tracking-wide">
              TÍNH GIÁ NGAY
