            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    <h3 className="text-xl font-black font-montserrat text-gray-900 uppercase">{CONTACT_INFO.name}</h3>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4 group">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500 text-sm">Email: lienhe@kialongbien.vn</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-gray-100">
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                     <p className="text-sm text-gray-800 italic">
                       <span className="font-bold not-italic text-yellow-700">Lời nhắn từ {CONTACT_INFO.name}:</span> <br/>
                  ...
                  <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div>
                        ...
                        <input type="text" className="w-full p-3.5 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-kia-red focus:bg-white font-bold text-gray-900 transition-all" placeholder="Nhập tên của bạn" />
                      </div>
                      <div>
                        ...
                        <input type="tel" className="w-full p-3.5 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-kia-red focus:bg-white font-bold text-gray-900 transition-all" placeholder="09xx..." />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div>
                        ...
                        <div className="relative">
                          <select className="w-full p-3.5 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-kia-red focus:bg-white font-medium text-gray-900 appearance-none cursor-pointer">
                    ...
                    <div>
                      ...
                      <textarea rows={4} className="w-full p-3.5 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-kia-red focus:bg-white text-gray-900 transition-all" placeholder="VD: Tôi muốn lái thử dòng K3 vào cuối tuần này..."></textarea>
                    </div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center text-center p-6 bg-white rounded-xl shadow-sm border border-gray-100">
               ...
               <p className="text-sm text-gray-500 leading-relaxed">Mọi khoản thu chi đều có hóa đơn chứng từ của Đại lý. Không thu phí ngoài luồng.</p>
            </div>
            <div className="flex flex-col items-center text-center p-6 bg-white rounded-xl shadow-sm border border-gray-100">
