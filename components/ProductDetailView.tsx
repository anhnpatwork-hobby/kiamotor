        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="grid grid-cols-4 gap-4">
               {[1,2,3,4].map(i => (
                 <div key={i} className="aspect-video bg-gray-100 rounded-lg cursor-pointer border border-transparent hover:border-black transition-all">
                    <img src={car.image} className="w-full h-full object-cover opacity-70 hover:opacity-100" />
                 </div>
               ))}
            </div>
          </div>
            ...
            <div className="border-t border-gray-100 pt-6">
              ...
              <div className="flex justify-around text-center">
                 ...
                 <div>
                   ...
                   <span className="text-[10px] font-bold uppercase block text-gray-600">Đại lý<br/>3S Quốc Tế</span>
                 </div>
                 <div>
