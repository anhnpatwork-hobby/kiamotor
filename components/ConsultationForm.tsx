                ...
                <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select className="w-full p-4 rounded-lg bg-white/10 border border-white/20 text-white focus:outline-none focus:bg-white/20 focus:border-white transition-colors appearance-none">
